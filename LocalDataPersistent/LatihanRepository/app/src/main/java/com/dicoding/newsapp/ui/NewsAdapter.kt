...
class NewsAdapter(private val onBookmarkClick: (NewsEntity) -> Unit) : ListAdapter<NewsEntity, MyViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        //kode untuk menghandle apakah icon bookmark ditekan atau tidak

        /**
         * Pertanyaan pertama yang mungkin terbesit di benak Anda adalah mengapa kode ini ada di onBindViewHolder.
         * Bukankah biasanya ada di ViewHolder? Jawabannya adalah karena kita ingin menyimpan state dari bookmark
         * yang ditandai. Apabila Anda meletakkan kode ini di ViewHolder, maka state akan ikut
         * ter-recycle (daur ulang) yang menyebabkan tanda tidak semestinya.
         */
        ...
        ivBookmark.setOnClickListener {
            /**
             * onBookmarkClick merupakan sebuah lambda yang digunakan seperti callback untuk melakukan
             * aksi di luar kelas adapter. Sehingga ketika ikon bookmark ditekan, ia akan memanggil blok berikut pada NewsFragment:
             */
