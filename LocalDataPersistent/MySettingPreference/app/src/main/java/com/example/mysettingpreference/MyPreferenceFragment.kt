...
class MyPreferenceFragment: PreferenceFragmentCompat(),
    ...
    /**
     * Perintah setSummary berguna untuk mengubah value dari EditTextPreference menjadi nilai yang
     * baru sesuai dengan data yang tersimpan.
     */
    ...
    /**
     * ketika terjadi perubahan maka panggil onResume dan onPause
     *
     * kode tersebut untuk me-register dan me-unregister ketika app ditutup
     * supaya listener tidak berjalan terus menerus dan menyebabkan memory leak
     */
    ...
    /**
     * function init untuk memanggil komponen editTextPreferences dan checkBoxPreference berdasarkan key
     */
    private fun init() {
    ...
    /**
     * fungsi dibawah ini untuk mengecek apakah terjadi perubahan pada data yang tersimpan di halaman setting
     * jika terjadi perubahan maka akan memanggil listener onSharedPreferenceChanged
     * lakukan validasi terlebih dahulu dengan mencocokan key mana yang berubah untuk mendapatkan value yg berubah
     */
