 ...
 *
 * Nah, di kelas ini kita menggunakan variabel yang ada pada DatabaseContract untuk mengisi kolom nama tabel.
 * Begitu juga dengan kelas-kelas lainnya nanti. Dengan memanfaatkan kelas contract, maka akses nama tabel
 * dan nama kolom tabel menjadi lebih mudah.
 */
