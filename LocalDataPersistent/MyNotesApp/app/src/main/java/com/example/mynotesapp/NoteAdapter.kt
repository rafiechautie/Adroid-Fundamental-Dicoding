...
class NoteAdapter(private val onItemClickCallback: OnItemClickCallback): RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    /**
     * method untuk menambahkan item baru ke dalam list + memberi animasi jika ada data baru
     */
    ...
    /**
     * method untuk mengupdate item + memberi animasi jika ada update
     */
    ...
    /**
     * method untuk menghapus item + memberi animasi jika ada item yang di delete
     */
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): NoteAdapter.NoteViewHolder {
